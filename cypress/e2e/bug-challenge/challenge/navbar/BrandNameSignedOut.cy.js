...
describe("User clicks the brand name in the nav prior to signing in", function () {
    const auth = new Auth();
    ...
    it ("Verifies the user is able to successfully navigate to the auth screen", () => {
        auth.navigate();
    ...
    it ("Verifies the user is able successfully log into the the application", () => {
        auth.login();
    })
